...
⚠️ The present reference architecture implementation for Azure has been deprecated. It will continue to be available at this location for some time, but not receive further updates.
